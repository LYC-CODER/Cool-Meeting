                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>会议名称：</td>
                                <td>
                                    <input type="text" id="meetingname" value="<#if meetingDTO??>${meetingDTO.meetingname!''}</#if>" maxlength="20"/>
                                </td>
                                <td>会议室名称：</td>
                                <td>
                                    <input type="text" id="roomname" value="<#if meetingDTO??>${meetingDTO.roomname!''}</#if>" maxlength="20"/>
                                </td>
                                <td>预定者姓名：</td>
                                <td>
                                    <input type="text" id="reservername"  value="<#if meetingDTO??>${meetingDTO.reservationistname!''}</#if>"maxlength="20"/>
                                </td>
                            </tr>
                            <tr>
                                <td>预定日期：</td>
